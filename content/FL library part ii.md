...
[^FN]: This volume, listed in the print catalogue as *Plura ac diversa divi Aurelii Augustini Sermonum Opera videlicet*, seems to have gone missing from the UT library. The oldest book from the collection still present is Solinus's *De memorabilibus mundi* in an edition from 1512 [A100:1354]. 


I think of him as Anglo-Saxon historian, but started with later medieval history and had many more books on late med history than early

FL also seems to have been interested in teaching; in philosophy(?), Jewish history, modern history. A lot of geography (maps, descriptions etr) and more on social and cultural history than I had expected (e.g. on homes, clothes etr)
...
"Geogr." category used for e.g. *Völkerkunde* by Peschel
Book on Nordic mythology is 'ant germ'; 

There is little linguistcs/philology; there is less than expected on other early medieval laws. He was a high medievalist and mainly interested in English law - biggest of his own categories must surely be "Jus angl"

He read about contemporary law as well 
...
a book about learning Swedish, 
lots on Shakespeare



Mention some of the books that Arimitsu says he doesn't have, which he does, like Maitland and Pollock
